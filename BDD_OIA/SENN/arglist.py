...
def get_senn_parser():
    ...
    ### Save Paths
    parser.add_argument(
        "--model_path", type=str, default="models", help="where to save the snapshot"
    )
    parser.add_argument(
        "--results_path",
        type=str,
    ...
    ### Device
    parser.add_argument(
        "--cuda", action="store_true", default=False, help="enable the gpu"
    )
    ...
    # Concept Encoder (H)
    parser.add_argument(
        "--cbm", default=True, help="type of conceptizer (learnt or input)"
    )  # newly added
    parser.add_argument(
        "--senn",
        action="store_true",
    ...
    parser.add_argument(
        "--concept_dim", type=int, default=1, help="concept dimension. dont change"
    )
    parser.add_argument(
        "--nconcepts_labeled", type=int, default=21, help="number of labeled concepts"
    )  # newly added
    ...
    parser.add_argument(
        "--info_hypara", type=float, default=0.5, help="hyperparameter of info loss"
    )  # newly added
    ...
    parser.add_argument(
        ...
        choices=["simple", "alexnet", "vgg8", "vgg11_bn", "vgg11", "vgg16"],
    )
    parser.add_argument(
        "--theta_dim",
        type=int,
    ...
    ### Learning
    parser.add_argument(
        "--opt", type=str, default="adam", help="optim method [default: adam]"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dataset", default="pathology", help="choose which dataset to run on"
    )
    parser.add_argument(
        "--embedding", default="pathology", help="choose what embeddings to use"
    )
    parser.add_argument("--nclasses", type=int, default=2, help="number of classes")

    ### Misc
    parser.add_argument(
        "--num_workers", type=int, default=30, help="num workers for data loader"
    )
    parser.add_argument(
        "--print_freq",
        type=int,
...
def parse_args():
    ...
    parser.add_argument(
        "--epochs", type=int, default=3, help="number of epochs for train [default: 10]"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--nconcepts_labeled", type=int, default=6, help="number of labeled concepts"
    )  # newly  added
    ...
    # data loading
    parser.add_argument(
        "--num_workers", type=int, default=4, help="num workers for data loader"
    )
