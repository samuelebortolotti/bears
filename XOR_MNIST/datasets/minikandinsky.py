    ...
    def get_data_loaders(self):
        ...
        if not hasattr(self, "dataset_train"):
            self.dataset_train = miniKAND_Dataset(
                base_path="data/kand-3k", split="train", finetuning=self.args.finetuning
            )
        ...
        if not self.args.preprocess:
            ...
            val_loader = KAND_get_loader(dataset_val, 1, val_test=True)
            test_loader = KAND_get_loader(dataset_test, 1, val_test=True)
