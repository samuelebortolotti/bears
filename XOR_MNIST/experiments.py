# Experiments module
# Contains args for different experiments
import copy
import itertools
...
def launch_KAND(args):
    """Runs Kandinksy patters
    ...
    # model specifics
    args.model = "kanddpl"
    args.checkin = "data/ckpts/kanddpl-150-entropy.pt"

    # wandb settings
    args.wandb = "emanuele95zr"
    args.project = "patterns"
    ...
    hyperparameters = [[2, 5], [0]]  # lambda_h  # seed

    args_list = []

    for element in itertools.product(*hyperparameters):
        args1 = copy.copy(args)
        args1.lambda_h, args1.seed = element
        # args1 = set_best_args_halfmnist(args1)
        print(args1, "\n")
...
def launch_bayes_halfmnist(args):
    """Runs Bayes Halfmnist
    ...
    for element in itertools.product(*hyperparameters):
        args1 = copy.copy(args)
        args1.model, args1.joint = element
        args1 = set_best_args_halfmnist(args1)
        print(args1, "\n")
        args_list.append(args1)
...
def launch_XOR(args):
    ...
    for element in itertools.product(*hyperparameters):
        args1 = copy.copy(args)
        args1.model, args1.rec, args1.entropy, args.gamma, args.lr = (
            element
        )
        print(args1, "\n")
        args_list.append(args1)
...
def launch_XOR_exp1(args):
    ...
    for element in itertools.product(*hyperparameters):
        args1 = copy.copy(args)
        args1.model, args1.disent, args1.s_w, args1.seed, args1.lr = (
            element
        )
