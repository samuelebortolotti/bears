...
def get_parser() -> ArgumentParser:
    """Method which returns the mnistslrec parser

    Returns:
        pars: argument parser
    """
...
class MnistSLRec(CExt):
    """SEMANTIC LOSS MNIST NETWORK WITH RECONSTRUCTION"""
    ...
    def __init__(
        ...
        Args:
            ...
            task (str, ,default='addition'): which task to perform
        ...
        """
        super(MnistSLRec, self).__init__(
    ...
    def forward(self, x):
        ...
        Returns:
            out_dict: dictionary predictions with reconstruction
        """
        # Image encoding
        cs, mus, logvars = [], [], []
        latents = []
    ...
    def normalize_concepts(self, z, split=2):
        ...
        Args:
            ...
            split (int, default=2): how many split to perform

        Returns:
            vect: normalized concepts probabilities
        """
    ...
    def get_loss(self, args):
        """Returns the loss function for MNIST SL Rec
