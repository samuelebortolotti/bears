# Mnist LTN with Reconstruction module
import torch
...
def get_parser() -> ArgumentParser:
    """Returns argument parser from this architecture
...
class MnistLTNRec(CExt):
    ...
    def __init__(
        self, encoder, decoder, n_images=2, c_split=(), args=None
    ):
        super(MnistLTNRec, self).__init__(
    ...
    def get_loss(self, args):
        ...
        Raises:
            err: NotImplementedError if loss function is not specified
        """
    ...
    def start_optim(self, args):
        """Initialize the optimizer for this architecture
