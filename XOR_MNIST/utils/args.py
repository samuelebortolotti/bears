...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--exp_decay", type=float, default=0.99, help="Exp decay of learning rate."
    )
    ...
    # deep ensembles
    parser.add_argument(
        "--n_ensembles", type=int, default=5, help="Number of model in DeepEnsembles"
    )
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--finetuning", type=int, default=0, help="Phase of active learning"
    )
...
def add_test_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="frequentist",
        choices=["frequentist", "mcdropout", "ensemble", "laplace", "bears"],
    ...
    parser.add_argument(
        "--real-kl", action="store_true", default=False, help="Real paper KL."
    )
    parser.add_argument(
        "--evaluate-all",
        action="store_true",
    ...
    parser.add_argument(
        "--lambda_h", type=float, default=1, help="Lambda for the KL divergence"
    )
    parser.add_argument(
        "--skip_laplace",
        action="store_true",
